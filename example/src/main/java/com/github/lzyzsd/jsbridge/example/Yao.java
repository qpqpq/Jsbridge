...
public class Yao extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (BridgeWebView) findViewById(R.id.webViewy);
        button = (ImageButton) findViewById(R.id.backy);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Yao.this,AA.class));
                finish();
            }
        });
        ...
        webView.loadUrl("http://"+ Config.IP3 +"/#/medicine?" + getPP());
