...
public class Tixing extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (BridgeWebView) findViewById(R.id.webViewt);
        button = (ImageButton) findViewById(R.id.backt);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Tixing.this,AA.class));
                finish();
            }
        });
        ...
        webView.loadUrl("http://"+ Config.IP3 +"/#/remind?" + getPP());
