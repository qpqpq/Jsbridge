...
public class Sugar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (BridgeWebView) findViewById(R.id.webViews);
        button = (ImageButton) findViewById(R.id.backs);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Sugar.this,AA.class));
                finish();
            }
        });
        ...
        webView.loadUrl("http://"+ Config.IP3 +"/#/bloodSugar?" + getPP());
