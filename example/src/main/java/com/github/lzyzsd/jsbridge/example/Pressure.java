...
public class Pressure extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (BridgeWebView) findViewById(R.id.webViewp);
        button = (ImageButton) findViewById(R.id.backp);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Pressure.this,AA.class));
                finish();
            }
        });
        ...
        webView.loadUrl("http://"+ Config.IP3 +"/#/bloodPressure?" + getPP());
