...
public class Info extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (BridgeWebView) findViewById(R.id.webViewi);
        button = (ImageButton) findViewById(R.id.backi);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (Config.first) {
                    startActivity(new Intent(Info.this, AA.class));
                    Config.first=false;
                }
                finish();
            }
        ...
        webView.loadUrl("http://"+Config.IP3+"/#/information?" + getPP());
