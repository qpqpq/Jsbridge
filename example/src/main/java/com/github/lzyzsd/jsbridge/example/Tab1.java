...
public class Tab1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        xueyaguanli = (Button) findViewById(R.id.txueyaguanli);
        xuetangguanli = (Button) findViewById(R.id.txuetangguanli);
        tizhongguanli = (Button) findViewById(R.id.ttizhongguanli);
        yundongguanli = (Button) findViewById(R.id.tyundongguanli);
        yongyaoguanli = (Button) findViewById(R.id.tyongyaoguanli);
        tixingshezhi = (Button) findViewById(R.id.ttixingshezhi);
        tianqi = (TextView) findViewById(R.id.ttianqi);
        pm = (TextView) findViewById(R.id.tpm);
        kongqizhiliang = (TextView) findViewById(R.id.tkongqizhiliang);
        tizhong = (TextView) findViewById(R.id.ttizhong);
        xuetang = (TextView) findViewById(R.id.txuetang);
        xueya = (TextView) findViewById(R.id.txueya);
        tixingshixiang = (TextView) findViewById(R.id.ttixingshixiang);
        fuyaotixing = (TextView) findViewById(R.id.tfuyaotixing);
        xueyaguanli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tab1.this, Pressure.class);
        ...
        xuetangguanli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tab1.this, Sugar.class);
                startActivity(intent);
            }
        });
        yongyaoguanli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tab1.this, Yao.class);
                startActivity(intent);
            }
        });
        tizhongguanli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tab1.this, Weight.class);
                startActivity(intent);
            }
        });
        yundongguanli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tab1.this, Exercise.class);
                startActivity(intent);
            }
        });
        tixingshezhi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tab1.this, Tixing.class);
                startActivity(intent);
            }
        });
...
//        });
    ...
    public static List<String> yao(String s) {
    ...
    public static String getLast2(String s) {
        try {
            JSONObject jsonObject = new JSONObject(s);
    ...
    public String getA(final String url) {
        ...
        FutureTask<String> task = new FutureTask<String>(new Callable<String>() {
            ...
            public String call() throws Exception {
                ...
                httpURLConnection.setRequestProperty("token", getPP(Tab1.this));
//                httpURLConnection.addRequestProperty("user-agent", "Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36");
    ...
    static String getPP(Context context) {
