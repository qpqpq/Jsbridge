...
public class Weight extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (BridgeWebView) findViewById(R.id.webVieww);
        button = (ImageButton) findViewById(R.id.backw);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Weight.this,AA.class));
                finish();
            }
        });
        ...
        webView.loadUrl("http://"+ Config.IP3 +"/#/weight?" + getPP());
